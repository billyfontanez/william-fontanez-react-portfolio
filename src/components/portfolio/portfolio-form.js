...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://williamfontanez.devcamp.space/portfolio/portfolio_items",
      apiAction: "post"
    };
  ...
  componentDidUpdate() {
    if (Object.keys(this.props.portfolioToEdit).length > 0) {
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://williamfontanez.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
  ...
  componentConfig() {
    return {
      iconFiletypes: [".jpg", ".png", ".gif", ".mp4", ".jpeg"],
